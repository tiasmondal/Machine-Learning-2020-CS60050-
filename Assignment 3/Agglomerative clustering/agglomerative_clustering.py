...
distance=np.random.random((10,10))          #Test distances for checking code
...
distance = np.load("distance_new_inverse_cosine.dat", allow_pickle=True)
#distance=[[0,9,3,6,11],[9,0,7,5,10],[3,7,0,9,2],[6,5,9,0,8],[11,10,2,8,0]];   #Test distances
...
np.savetxt("clusters_agglomerative.txt",clusters,fmt="%s");
np.array(clusters).dump("clusters_agglomerative.dat")